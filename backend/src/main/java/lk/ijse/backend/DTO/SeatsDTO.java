...
public class SeatsDTO {
    ...
    public SeatsDTO(String rowLetter, Integer seatNumber, boolean isAvailable, FilmHall filmHall, SeatTypeDTO seatTypeDTO) {
        this.rowLetter = rowLetter;
        this.seatNumber = seatNumber;
    ...
    public void setSeatType(SeatTypeDTO seatTypeDTO) {
        this.seatTypeDTO = seatTypeDTO;
    }
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof SeatsDTO)) return false;
        SeatsDTO seat = (SeatsDTO) o;
        return Objects.equals(id, seat.id) &&
                Objects.equals(filmHall, seat.filmHall) &&
                Objects.equals(rowLetter, seat.rowLetter) &&
                Objects.equals(seatNumber, seat.seatNumber) &&
                Objects.equals(seatTypeDTO, seat.seatTypeDTO) &&
                isAvailable == seat.isAvailable;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, filmHall, rowLetter, seatNumber, seatTypeDTO, isAvailable);
    }
